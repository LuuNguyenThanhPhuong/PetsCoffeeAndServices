				...
				<div id="login" class="row">
					...
					<div
						...
						<ul class="auth-block__menu-list">
							<li class="active"><a href="" title="Đổi mật khẩu">Đổi
									mật khẩu</a></li>
						</ul>
						<div id="recover-password" class="form-signup">
							<div class="fix-sblock text-center">Bạn muốn đổi mật khẩu
								vui lòng nhập các trường để đổi mật khẩu.</div>
							<form accept-charset="utf-8" action="/admin/account/change"
								...
								<div class="form-signup clearfix">
									<fieldset class="form-group margin-bottom-10">
										<label>User name<span class="required">*</span></label> <input
											...
											name="maNhanVien" id="customer_user" required=""
											data-validation="maNhanVien"
								...
								<div class="action_bottom text-center">
									<button class="btn btn-style btn-blues"
										...
										value="Lấy lại mật khẩu">Đổi mật khẩu</button>
								</div>
								<div class="text-login text-center">
									<p>
										Về Trang Chủ <a href="/admin/home/index" title="Quay lại">tại
											đây.</a>
									</p>
								</div>
							</form>
